...
• [NMEA](http://aprs.gids.nl/nmea/) protokolün $GPxxxx ile başlayan 19 farklı veri kodu hakkında bilgi alabiliriz. <br>
• Kullanılan kütüphanelerde GPS çalıştırırken Interrupt aktif edilmesi gerekir. <br>
...
• Eğer gps.h ve gps.c kütüphanesini kullanmak istersek konfigürasyon kısmında değişiklik yapmadan main.c dosyasını aşağıdaki gibi düzeltilir. <br>
