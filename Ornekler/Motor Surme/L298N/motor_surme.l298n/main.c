...
void ileri(int hiz)
    {
		__HAL_TIM_SET_COMPARE(&htim4,TIM_CHANNEL_1, hiz);
        HAL_GPIO_WritePin(GPIOA, IN1_Pin, GPIO_PIN_SET);
        HAL_GPIO_WritePin(GPIOA, IN2_Pin,GPIO_PIN_RESET);

        __HAL_TIM_SET_COMPARE(&htim4,TIM_CHANNEL_2, hiz);
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  HAL_UART_Receive(&huart1, (uint8_t *)rx_buff,1, 100);
