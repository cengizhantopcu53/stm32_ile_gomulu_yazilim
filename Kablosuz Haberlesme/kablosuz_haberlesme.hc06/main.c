...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
      HAL_UART_Receive(&huart2, (uint8_t *)rx_buff,1, 100);
      ...
      if(rx_buff[0]=='1'){
          ...
          HAL_UART_Transmit(&huart2, (uint8_t *)tx_buff, sprintf(tx_buff,"Yesil Led Acik\n"), 100);
      }
      else if(rx_buff[0]=='2'){
          ...
          HAL_GPIO_WritePin(GPIOD, RED_Pin, GPIO_PIN_RESET);
          HAL_GPIO_WritePin(GPIOD, BLUE_Pin, GPIO_PIN_RESET);
          HAL_UART_Transmit(&huart2, (uint8_t *)tx_buff, sprintf(tx_buff,"Turuncu Led Acik\n"), 100);
      }
      else if(rx_buff[0]=='3'){
          HAL_GPIO_WritePin(GPIOD, GREEN_Pin, GPIO_PIN_RESET);
          HAL_GPIO_WritePin(GPIOD, ORANGE_Pin, GPIO_PIN_RESET);
          ...
          HAL_GPIO_WritePin(GPIOD, BLUE_Pin, GPIO_PIN_RESET);
          HAL_UART_Transmit(&huart2, (uint8_t *)tx_buff, sprintf(tx_buff,"Kirmizi Led Acik\n"), 100);
      }
      else if(rx_buff[0]=='4'){
          HAL_GPIO_WritePin(GPIOD, GREEN_Pin, GPIO_PIN_RESET);
          HAL_GPIO_WritePin(GPIOD, ORANGE_Pin, GPIO_PIN_RESET);
          ...
          HAL_UART_Transmit(&huart2, (uint8_t *)tx_buff, sprintf(tx_buff,"Mavi Led Acik\n"), 100);
      }
      else if(rx_buff[0]=='5'){
    	  HAL_GPIO_WritePin(GPIOD, GREEN_Pin|ORANGE_Pin|RED_Pin|BLUE_Pin, GPIO_PIN_SET);
          HAL_UART_Transmit(&huart2, (uint8_t *)tx_buff, sprintf(tx_buff,"Tum Ledler Acik\n"), 100);
      }
      else{
    	  HAL_GPIO_WritePin(GPIOD, GREEN_Pin|ORANGE_Pin|RED_Pin|BLUE_Pin, GPIO_PIN_RESET);
    	  HAL_UART_Transmit(&huart2, (uint8_t *)tx_buff, sprintf(tx_buff,"Tum Ledler Kapali\n"), 100);
      }
      HAL_Delay(500);
  }
  /* USER CODE END 3 */
